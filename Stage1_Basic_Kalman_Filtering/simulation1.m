...
%% Full Simulation: Includes Steady-State Kalman Gain via Riccati + Comparison of Equation (7) and (8)
...
for rep = 1:N
    ...
    % Step 2: Each forecaster observes noisy signal and updates belief
    signals = zeros(M,T-1);
    yhat = zeros(M,T-1);
    for i = 1:M
        for t = 2:T
